...
class AssignmentController extends RController
{
	...
	*/
	public function actionView()
	{
		...
		$dataProvider = new ERAssignmentDataProvider(array(
			'pagination'=>array(
				'pageSize'=>50,
			),
		));
	...
	*/
	public function actionUser()
	{
        ...
        $criteria->{$this->module->userIdColumn}('==',new MongoId($_GET['id']));
		$model = EMongoDocument::model($userClass)->find($criteria); //CActiveRecord::model($userClass)->findByPk($_GET['id']);
