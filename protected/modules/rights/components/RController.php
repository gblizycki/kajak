...
class RController extends CController
{
	...
	*/
	public function filterRights($filterChain)
	{
        ...
        $filter->changePasswordUrl = Rights::module()->changePasswordUrl;
        $filter->generatePasswordUrl = Rights::module()->generatePasswordUrl;
        $filter->checkPasswordDate = Rights::module()->checkPasswordDate;
